...
export function PanicButton({ onFire }: { onFire: () => void }) {
  ...
  return (
    <button
      ...
      className="relative cursor-pointer overflow-hidden rounded-lg border border-refuse/40 bg-surface px-2.5 py-[3px] text-[11.5px] tracking-[0.1em] text-refuse uppercase select-none"
    >
      <span
